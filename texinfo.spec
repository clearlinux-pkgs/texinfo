...
Version  : 7.2
Release  : 37
URL      : https://mirrors.kernel.org/gnu/texinfo/texinfo-7.2.tar.gz
Source0  : https://mirrors.kernel.org/gnu/texinfo/texinfo-7.2.tar.gz
Source1  : update-info.path
Source2  : update-info.service
Source3  : https://mirrors.kernel.org/gnu/texinfo/texinfo-7.2.tar.gz.sig
Source4  : DDBC579DAB37FBA9.pkey
Source5  : update-info
...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) DDBC579DAB37FBA9' gpg.status
%setup -q -n texinfo-7.2
cd %{_builddir}/texinfo-7.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735116342
...
cp %{_builddir}/texinfo-%{version}/tp/maintain/lib/Text-Unidecode/LICENSE %{buildroot}/usr/share/package-licenses/texinfo/abd421a413ff950b1f4a0ad53ddffe8d9ceeb590 || :
...
/usr/share/info/texinfo.info-4

%files lib
%defattr(-,root,root,-)
/usr/lib64/texi2any/ConvertXS.so
/usr/lib64/texi2any/DocumentXS.so
/usr/lib64/texi2any/IndicesXS.so
/usr/lib64/texi2any/MiscXS.so
/usr/lib64/texi2any/Parsetexi.so
/usr/lib64/texi2any/StructuringTransfoXS.so
/usr/lib64/texi2any/XSParagraph.so
/usr/lib64/texi2any/libtexinfo-convert.so
/usr/lib64/texi2any/libtexinfo-convert.so.0
/usr/lib64/texi2any/libtexinfo-convert.so.0.0.0
/usr/lib64/texi2any/libtexinfo-convertxs.so
/usr/lib64/texi2any/libtexinfo-convertxs.so.0
/usr/lib64/texi2any/libtexinfo-convertxs.so.0.0.0
/usr/lib64/texi2any/libtexinfo.so
/usr/lib64/texi2any/libtexinfo.so.0
/usr/lib64/texi2any/libtexinfo.so.0.0.0
/usr/lib64/texi2any/libtexinfoxs.so
/usr/lib64/texi2any/libtexinfoxs.so.0
/usr/lib64/texi2any/libtexinfoxs.so.0.0.0
...
/usr/share/package-licenses/texinfo/abd421a413ff950b1f4a0ad53ddffe8d9ceeb590
...
%files locales -f texinfo.lang -f texinfo_document.lang
%defattr(-,root,root,-)
